...
Route::get('/llms.txt', function () {
    $lines = [
        ...
        '',
        'Users should save or reuse only content they own or have permission to save. HDVideoDownloader does not provide access to private, paid, login-only, or restricted media.',
        '',
        ...
        '## Main Pages',
        '',
        '- [Homepage](https://hdvideodownloader.online/): Public-link media analyzer, supported sources, features, FAQs, and guides.',
        '- [Supported Platforms](https://hdvideodownloader.online/supported-platforms): Directory of supported public media sources.',
        '- [Blog and Guides](https://hdvideodownloader.online/blog): Guides about media formats, quality, compatibility, and responsible use.',
        ...
        '## Platform Tools',
        '',
        '- [YouTube Public Link Guide](https://hdvideodownloader.online/youtube-video-downloader): Information about supported public YouTube videos and Shorts.',
        '- [Facebook Public Link Guide](https://hdvideodownloader.online/facebook-video-downloader): Information about public Facebook videos and Reels.',
        '- [Instagram Public Link Guide](https://hdvideodownloader.online/instagram-video-downloader): Information about supported public Instagram Reels and video posts.',
        '- [TikTok Public Link Guide](https://hdvideodownloader.online/tiktok-video-downloader): Information about supported public TikTok videos and share links.',
        '- [Twitter/X Public Link Guide](https://hdvideodownloader.online/twitter-video-downloader): Information about supported public X and Twitter status videos.',
        '- [Vimeo Public Link Guide](https://hdvideodownloader.online/vimeo-video-downloader): Information about supported public Vimeo videos and creator-authorized formats.',
        '- [Dailymotion Public Link Guide](https://hdvideodownloader.online/dailymotion-video-downloader): Information about supported public Dailymotion video URLs.',
        '- [Pinterest Public Link Guide](https://hdvideodownloader.online/pinterest-video-downloader): Information about supported public Pinterest video Pins.',
        '',
        '## Trust and Legal',
        '',
