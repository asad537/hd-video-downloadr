    ...
    private function content(array $p): array
    {
        $sections = [
            ...
            ['How to review a public ' . $p['name'] . ' link', [
                "Open {$p['name']} and navigate to the public video you are authorized to use. Use the platform's share menu and choose Copy Link. Return to HDVideoDownloader, paste the complete URL into the field near the top of this page, and start analysis. The analyzer checks the host, requests public metadata, and lists the formats it can detect.",
