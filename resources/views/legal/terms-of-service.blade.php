...
<head>
    ...
    <meta property="og:title" content="{{ $seo->meta_title ?? 'Terms of Service | HDVideoDownloader' }}">
    <meta property="og:description" content="{{ $seo->meta_description ?? 'Read the HDVideoDownloader terms of service.' }}">
